import type { GitHubDataset, ProfileStudioConfig } from "./domain";
import { defaultPrivacySettings } from "./privacy";
import type { StudioLocale } from "./language";

export function demoGitHubDataset(username: string): GitHubDataset {
...
export function demoProfileConfig(username: string, locale: StudioLocale): ProfileStudioConfig {
